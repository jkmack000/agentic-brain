...
- `project-brain/INDEX-MASTER.md` — fat index of all brain knowledge
- `project-brain/specs/SPEC-000_project-brain-architecture.md` — brain system architecture
- `project-brain/specs/SPEC-001_prover-multi-brain-architecture.md` — Prover multi-brain architecture
